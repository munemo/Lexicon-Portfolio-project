...
from .forms import UserForm, UserProfileInfoForm, SubscriberInfoForm, ContactForm, MailJobListForm, ProfileUpdateForm
from .models import UserProfileInfo, SubscriberInfo
...
def profile_edit(request):
    if request.method == 'POST':
        ...
        if p_form.is_valid():
            ...
            return redirect('basic_app:portfolio')  # Redirect back to profile page
    else:
    ...
    if request.method == 'POST':
        ...
        if subscriber_form.is_valid():
            ...
            message = 'Thank you for your subscription!' \
                      'Check your mailbox regularly for the hottest jobs in the tech field!'
            ...
            if subject and message and from_email:
                ...
                return render(request, 'basic_app/subscribe.html',
                              {'subscriber_form': subscriber_form, 'subscribed': subscribed})
            else:
